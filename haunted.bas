  ...
  485 T=T+1:IF T>200 THEN PRINT"MIDNIGHT HAS STRUCK. YOU'VE BEEN TURNED INTO A BAT":END
  490 GOTO255
  500 COLOUR COLINTGREEN% : PRINT TAB(LT%,20)"WORDS I KNOW:"
  505 COLOUR COLINTYELLOW% : PRINT TAB(LT%,22);"";
  510 FOR I=1 TO V
  520  PRINT V$(I);",";
  530 NEXT I
  540 M$="":PRINT
  ...
  780 IF F(14)=1 THEN M$="CRASH! YOU FELL OUT OF THE TREE!":F(14)=0:PROCfall:RETURN
 ...
 1150 IF (OB=3 OR OB=36) AND C(3)=1 AND F(34)=0 THEN M$="USE THIS MAGIC WORD WITH CARE 'XZANFAR'"
 ...
 2340 FORI=1 TO 10
 2350 SOUND0,-15,5,1
 2360 FORM=1TO400:NEXTM
 2370 NEXTI
 2380 ENDPROC
 2390 :
 2400 DEFPROCgeneral
 2410 SOUND2,-15,100,2
 2420 FORM=1TO400:NEXTM
 ...
 5450 = ANSWER
 5500 :
 5505 DEF PROC_INITSCREEN : REM *********** INITSCREEN ***********
 5510 MODE mode%
 ...
 7700 :
 7710 DEF PROC_LOAD_CHARS : REM ************ LOAD CHARS ***********
